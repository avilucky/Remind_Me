...
class ReminderDetailViewController: UIViewController {
    ...
    @IBAction func dismissButtonClicked() {
        ...
        if(activeReminders[reminderByIndex!] == nil){
            let alertController = UIAlertController(title: "Dismiss Error", message: "The detail view is of a stale reminder. You will be redirected to home and you can perform appropriate action from there", preferredStyle: UIAlertControllerStyle.alert)
