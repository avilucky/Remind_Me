...
class LandmarkBasedRemindersViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let pickerData = ["leaving", "nearby", "reached"]
    ...
    */
    ...
    @IBAction func saveReminder() {
        ...
        let eveType: EventType = getEventType(eventType: eventTypePicker.description)
